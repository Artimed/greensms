...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get onboardingSubtitle => 'SMS بینکنگ آپریشنز کے لیے بصری اسسٹنٹ';

  @override
  String get onboardingFeatureLocal =>
      'مقامی طور پر کام کرتا ہے، انٹرنیٹ درکار نہیں';

  @override
  String get onboardingFeatureSms => 'صرف آخری 10 SMS پڑھتا ہے';

  @override
  String get onboardingFeaturePrivacy =>
      'ڈیٹا کبھی بیرونی طور پر نہیں بھیجا جاتا';

  @override
  String get onboardingFeatureQr =>
      'QR صرف فون نمبر شیئر کرنے کے لیے استعمال ہوتا ہے';

  @override
  String get onboardingButton => 'اجازتیں دیں اور جاری رکھیں';

  @override
  String get accounts => 'اکاؤنٹس';

  @override
  String get noAccountsYet => 'ابھی تک کوئی شناخت شدہ اکاؤنٹ نہیں۔';

  @override
  String get latestSms => 'تازہ ترین SMS';

  @override
  String get smsNotLoaded => 'SMS ابھی لوڈ نہیں ہوئے۔';

  @override
  String get qrModeTitle => 'QR موڈ';

  @override
  String get qrModeSubtitle => 'فل اسکرین کیمرا کھولیں';
  ...
  @override
  String get dailyTransferLimit => 'یومیہ ٹرانسفر حد';
  ...
  @override
  String get devicePhoneTitle => 'ڈیوائس فون';

  @override
  String get devicePhoneDesc =>
      'آپ کے نمبر کے ساتھ QR بنانے کے لیے استعمال ہوتا ہے';
  ...
  @override
  String get themeTitle => 'ظاہری شکل';

  @override
  String get languageTitle => 'زبان';

  @override
  String get bankRoutingTitle => 'ملک اور بینک';
  ...
  @override
  String get permissionsTitle => 'اجازتیں';

  @override
  String get readSmsTitle => 'SMS پڑھیں';
  ...
  @override
  String get directSmsTitle => 'براہ راست SMS بھیجنا';
  ...
  @override
  String get cameraTitle => 'کیمرا';

  @override
  String get cameraDesc => 'For scanning QR';

  @override
  String get clearLocalDataTitle => 'مقامی ڈیٹا صاف کریں';
  ...
  @override
  String get setAccountFirst => 'پہلے ترتیبات میں اکاؤنٹ نمبر سیٹ کریں۔';

  @override
  String get chooseChannelTitle => 'ٹرانسفر چینل منتخب کریں';
  ...
  @override
  String get yourAccountTitle => 'آپ کا اکاؤنٹ';

  @override
  String get yourAccountDesc =>
      'آپ کے اکاؤنٹ نمبر کے ساتھ QR بنانے کے لیے استعمال ہوتا ہے';

  @override
  String get accountNumberLabel => 'اکاؤنٹ نمبر';

  @override
  String get snackAccountSaved => 'اکاؤنٹ محفوظ ہو گیا';

  @override
  String get selectBankFirstHint =>
      'ترتیب دینے کے لیے اوپر بینک منتخب کریں اور محفوظ کریں';
}
